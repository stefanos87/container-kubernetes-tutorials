...
CONTAINER_CMD_RUN="$CONTAINER_RUN_UTILITY run -it --name $CONTAINER_NAME -p $CONTAINER_PORT:8082 -e UPLOAD_DIR=$UPLOAD_DIR -e EXPOSED_PORT=$CONTAINER_PORT $CONTAINER_IMAGE_NAME:$CONTAINER_IMAGE_VERSION"
